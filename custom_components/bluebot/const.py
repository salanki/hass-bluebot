...
# FloDash Devices marks a meter online iff lastDatapoint.recordedAt is newer
# than one minute. Zero-flow meters also emit fresh datapoints. This measures
# cloud reporting, independently of local Wi-Fi / ICMP reachability.
CLOUD_OFFLINE_AFTER = timedelta(seconds=60)
